...
int main()
{
    ...
    // PHONEBOOK POINTER POINTS TO DIRECTORY OBJECT
    ...
    while (run)
    {
        ...
        case '6':
        {
            if (signIn == "Admin")
            {
                ...
                // WE TAKE LONGER NRANCH SO AS TO MAKE THE TREE MORE BALANCED
...
void loadTree()
{
    ...
    ifstream myFile("C://Users/DELL/OneDrive/Desktop/SEM3/ds/Project/" + fileName);
    if (myFile.is_open())
    {
...
string searchContact(string &fname, string &lname)
{
    ...
    { // phone field wasn't updated
        found = 0;
        return "Sorry! Unable to find any contact with name : " + fname + " " + lname;
    }
    else
    {
        found = 1;
